...
class Encrypt {
	...
	function get_key($key = '')
	{
		if ($key == '')
		{
			...
			$key = 'WhiteBox Libraries by FDCore Studio';

			if ($key === FALSE)
			{
				exit('In order to use the encryption class requires that you set an encryption key in your php file.');
			}
		}
