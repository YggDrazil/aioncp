...
<p> 
	...
	{if $online}<font color="lime">{$lang.online}</font> <img src="themes/i/error.png">{else}<font color="red">{$lang.offline}</font> <img src="themes/i/success.gif">{/if}
...
<p> 
	...
	<a href='javascript:void(0)' onclick="$('.chlevel').toggle('slow')" title='{$lang.edit}'>
		 			<img src='themes/i/edit.png' title='{$lang.edit}'></a>			
</p>
...
<p class='chlevel hideme'> 
	...
	<a href='javascript:void(0)' onclick="$('.ll').slideToggle('slow')"><img src='themes/i/wizard.png'></a>
